...
{
	private const string TableDefinition = "Name NVARCHAR(5), NativeName NVARCHAR(100), DisplayName NVARCHAR(100), EnglishName NVARCHAR(100), ThreeLetterISO NVARCHAR(3), TwoLetterISO NVARCHAR(2), IsNeutralCulture BIT, LCID INT, ANSICodePage INT";
